...
std::map<int, std::tuple<std::string, std::string>> explain_wm{
	...
	{ 0x4A, { "WM_COPYDATA", "An application sends the WM_COPYDATA message to pass data to another application." } },
	{ 0x1,
	  { "WM_CREATE",
	...
	{ 0x126, { "WM_MENUCOMMAND", "The WM_MENUCOMMAND message is sent when the user makes a selection from a menu." } },
	{ 0x123,
	  { "WM_MENUDRAG",
	...
	{ 0x85, { "WM_NCPAINT", "The WM_NCPAINT message is sent to a window when its frame must be painted." } },
	{ 0xA6,
	  { "WM_NCRBUTTONDBLCLK",
	...
	{ 0x218, { "WM_POWERBROADCAST", "Notifies applications that a power-management event has occurred." } },
	{ 0x317,
	  { "WM_PRINT",
	...
	{ 0x1E, { "WM_TIMECHANGE", "A message that is sent whenever there is a change in the system time." } },
	{ 0x113,
	  { "WM_TIMER",
